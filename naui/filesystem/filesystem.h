...
enum
{
	...
	NAUI_DIR_ROAMING,
	NAUI_DIR_DOWNLOADS,
	NAUI_DIR_PROGRAMS,			// 64bit path
	NAUI_DIR_PROGRAMS_X86,		// 32bit path
	NAUI_DIR_PROGRAMS_NATIVE,	// Built platform path
	NAUI_DIR_TEMP,
	// NAUI_DIR_CACHE,			// NOT IMPLEMENTED
	// NAUI_DIR_CONFIG,			// NOT IMPLEMENTED
	NAUI_DIR_ASSETS,
	NAUI_DIR_MAX_COUNT
};
