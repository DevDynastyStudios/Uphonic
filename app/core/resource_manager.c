...
static void uph_resources_clear_timeline_blocks_with_resource(Uph_TrackType track_type, Uph_ResourceIndex resource_index)
{
...
void uph_resources_remove_sample(Uph_ResourceIndex sample_index)
{
    ...
    uph_resources_clear_timeline_blocks_with_resource(UPH_TRACK_AUDIO, sample_index);
